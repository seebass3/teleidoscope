			...
			<div className="container">
				<div className="flex w-full items-start justify-between max-lg:flex-col max-lg:gap-y-lg lg:border-l lg:border-moss/35 lg:pl-line">
					<div className="flex flex-shrink items-start self-stretch">
						<div className="flex flex-col items-start gap-sm max-lg:border-l max-lg:border-moss/35 max-lg:pl-line lg:min-w-[206.15px] lg:pr-line">
							<h3 className="text-lg tracking-[-0.64px] text-moss">
								Latest Updates
							</h3>
